# Workflow: Complete SDR Lead Capture & Qualification Agent

## Overview

This document provides an overview of the 'Complete SDR Lead Capture & Qualification Agent' workflow.

## Workflow Steps (Nodes)

| Step Name | Type |
|-----------|------|
| Multi-Channel Lead Webhook | n8n-nodes-base.webhook |
| Instant Response to Lead | n8n-nodes-base.respondToWebhook |
| Store Lead in Airtable CRM | n8n-nodes-base.airtable |
| AI Lead Qualification Agent | @n8n/n8n-nodes-langchain.openAi |
| Parse AI Analysis | n8n-nodes-base.code |
| Update Lead with AI Insights | n8n-nodes-base.airtable |
| Route by Qualification Score | n8n-nodes-base.switch |
| HOT LEAD → Auto-Book Discovery Call | n8n-nodes-base.httpRequest |
| Update Status: Call Booked | n8n-nodes-base.airtable |
| Send Hot Lead Email | n8n-nodes-base.emailSend |
| WARM LEAD → Nurture Sequence | n8n-nodes-base.emailSend |
| Update Status: Nurturing | n8n-nodes-base.airtable |
| COLD LEAD → Archive with Nurture | n8n-nodes-base.airtable |
| Notify Team: Hot Lead | n8n-nodes-base.slack |
| Notify Team: Warm Lead | n8n-nodes-base.slack |
...
```json
{
  ...
  "nodes": [
    ...
    },
    {
      ...
      "name": "HOT LEAD \u2192 Auto-Book Discovery Call",
    ...
    },
    {
      "parameters": {
        ...
        "toEmail": "={{ $json.email }}",
        "subject": "Let's talk! Your discovery call is confirmed \ud83d\ude80",
        "emailFormat": "html",
        "options": {}
      },
    ...
    },
    {
      ...
      "name": "COLD LEAD \u2192 Archive with Nurture",
      "type": "n8n-nodes-base.airtable",
      "typeVersion": 2,
      "position": [
        0,
  ...
  "connections": {
    ...
    "Route by Qualification Score": {
      "main": [
        [
          {
            "node": "HOT LEAD \u2192 Auto-Book Discovery Call",
            "type": "main",
            "index": 0
          }
        ]
    ...
    "HOT LEAD \u2192 Auto-Book Discovery Call": {
      "main": [
        [
          {

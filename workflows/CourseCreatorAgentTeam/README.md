# Workflow: Course Creator Agent Team

## Overview

This document provides an overview of the 'Course Creator Agent Team' workflow.

## Workflow Steps (Nodes)

| Step Name | Type |
|-----------|------|
| Start Course Ideation | n8n-nodes-base.telegram |
| Course Idea Creator Agent | @n8n/n8n-nodes-langchain.agent |
| Structured Output Parser | @n8n/n8n-nodes-langchain.outputParserStructured |
| Start Course Creation | n8n-nodes-base.telegramTrigger |
| Sticky Note1 | n8n-nodes-base.stickyNote |
| Module Creator Agent | @n8n/n8n-nodes-langchain.agent |
| Structured Output Parser1 | @n8n/n8n-nodes-langchain.outputParserStructured |
| Update Modules | n8n-nodes-base.airtable |
...
| Start Module | n8n-nodes-base.airtable |
| Module Code | n8n-nodes-base.code |
| Module Created | n8n-nodes-base.airtable |
| Start Submodules | n8n-nodes-base.airtable |
| Get Each Module | n8n-nodes-base.airtable |
| Submodule Creator Agent | @n8n/n8n-nodes-langchain.agent |
| Submodule Code | n8n-nodes-base.code |
| Update Submodules | n8n-nodes-base.airtable |
| Submodules Created | n8n-nodes-base.airtable |
| Start Course | n8n-nodes-base.airtable |
| Courses Created | n8n-nodes-base.airtable |
| Sticky Note4 | n8n-nodes-base.stickyNote |
| Start Scripts | n8n-nodes-base.airtable |
| Split Out1 | n8n-nodes-base.splitOut |
| Loop Over Items1 | n8n-nodes-base.splitInBatches |
| Structured Output Parser3 | @n8n/n8n-nodes-langchain.outputParserStructured |
| Create Script | n8n-nodes-base.airtable |
| Get Submodules | n8n-nodes-base.airtable |
| Scripts Generated | n8n-nodes-base.airtable |
| gpt 4o | @n8n/n8n-nodes-langchain.lmChatOpenRouter |
| gpt 4o mini | @n8n/n8n-nodes-langchain.lmChatOpenRouter |
| gpt 4o mini1 | @n8n/n8n-nodes-langchain.lmChatOpenRouter |
| gpt 4o mini2 | @n8n/n8n-nodes-langchain.lmChatOpenRouter |
| searchCourse | n8n-nodes-base.airtableTool |
| Telegram Trigger | n8n-nodes-base.telegramTrigger |
| Switch | n8n-nodes-base.switch |
| If | n8n-nodes-base.if |
| Telegram | n8n-nodes-base.telegram |
| New User | n8n-nodes-base.telegram |
| Create User | n8n-nodes-base.airtable |
| Code | n8n-nodes-base.code |
| Ask Name | n8n-nodes-base.httpRequest |
| Sticky Note | n8n-nodes-base.stickyNote |
| Search User | n8n-nodes-base.airtable |
| Schedule Trigger | n8n-nodes-base.scheduleTrigger |
| Schedule Trigger1 | n8n-nodes-base.scheduleTrigger |
| Schedule Trigger2 | n8n-nodes-base.scheduleTrigger |
| Scriptwriter Agent | @n8n/n8n-nodes-langchain.agent |

# Workflow: Advanced Multi-Channel Customer Engagement Pipeline

## Overview

This document provides an overview of the 'Advanced Multi-Channel Customer Engagement Pipeline' workflow.

## Workflow Steps (Nodes)

| Step Name | Type |
|-----------|------|
| Webhook - Customer Form Submit | n8n-nodes-base.webhook |
| Schedule - Daily Reports | n8n-nodes-base.scheduleTrigger |
| Google Sheets - Read Customer Data | n8n-nodes-base.googleSheets |
| IF - Premium Customer Check | n8n-nodes-base.if |
| PostgreSQL - Fetch User History | n8n-nodes-base.postgres |
| HTTP Request - Clearbit Enrichment | n8n-nodes-base.httpRequest |
| HubSpot - Create/Update Contact | n8n-nodes-base.hubspot |
| SendGrid - Premium Welcome Email | n8n-nodes-base.sendgrid |
| Slack - Notify Sales Team | n8n-nodes-base.slack |
| Asana - Create Follow-up Task | n8n-nodes-base.asana |
| IF - Standard Customer Check | n8n-nodes-base.if |
| SendGrid - Standard Welcome Email | n8n-nodes-base.sendgrid |
| Google Sheets - Log Standard Lead | n8n-nodes-base.googleSheets |
| Function - Merge Customer Data | n8n-nodes-base.function |
| Code - Calculate Customer Score | n8n-nodes-base.code |
| Notion - Check Existing Record | n8n-nodes-base.notion |
| IF - New Customer in Notion | n8n-nodes-base.if |
| Notion - Create Customer Page | n8n-nodes-base.notion |
| Segment - Track Event | n8n-nodes-base.segment |
| HTTP Request - Create Stripe Customer | n8n-nodes-base.httpRequest |
| Mailchimp - Add to List | n8n-nodes-base.mailchimp |
| Merge - Combine Data Sources | n8n-nodes-base.merge |
| Split in Batches | n8n-nodes-base.splitInBatches |
| Wait - Rate Limiting | n8n-nodes-base.wait |
| Slack - Progress Updates | n8n-nodes-base.slack |
| IF - Validate Data Quality | n8n-nodes-base.if |
| Aggregate - Calculate Totals | n8n-nodes-base.aggregate |
| Sort - By Lifetime Value | n8n-nodes-base.sort |
| Item Lists - Split Tags | n8n-nodes-base.itemLists |
| HTTP Request - Create Intercom Contact | n8n-nodes-base.httpRequest |
| Google Calendar - Schedule Onboarding | n8n-nodes-base.googleCalendar |
| Google Drive - Backup Customer Data | n8n-nodes-base.googleDrive |
| Execute Workflow - Trigger Follow-up | n8n-nodes-base.executeWorkflow |
| Sticky Note | n8n-nodes-base.stickyNote |
| Sticky Note 2 | n8n-nodes-base.stickyNote |
| IF - High Value Segment (Video Trigger) | n8n-nodes-base.if |
| HeyGen - Generate Premium Video | n8n-nodes-community.heygen |
| Wait - For Video Generation | n8n-nodes-base.wait |
| TikTok - Post Welcome Video | n8n-nodes-community.tiktok |

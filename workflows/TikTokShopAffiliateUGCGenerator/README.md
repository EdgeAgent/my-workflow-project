# Workflow: TikTok Shop Affiliate UGC Generator

## Overview

This document provides an overview of the 'TikTok Shop Affiliate UGC Generator' workflow.

## Workflow Steps (Nodes)

| Step Name | Type |
|-----------|------|
| Schedule - Daily Run | n8n-nodes-base.scheduleTrigger |
| Google Sheets - Product Catalog Ingest | n8n-nodes-base.googleSheets |
| Split in Batches (Scale) | n8n-nodes-base.splitInBatches |
| Google Search - Fetch Viral Trends | n8n-nodes-base.googleSearch |
| Function - Gemini Script Generator (UGC Style) | n8n-nodes-base.function |
| HTTP Request - HeyGen Video Generation (Hyper-Realistic) | n8n-nodes-base.httpRequest |
| Wait - For Video Generation | n8n-nodes-base.wait |
| Slack - Post QC Approval Request | n8n-nodes-base.slack |
| Approval Waiter (QC Gate) | n8n-nodes-base.approval |
| IF - QC Approved (Hyper-Realistic) | n8n-nodes-base.if |
| HTTP Request - TikTok Post (Final Deliverable) | n8n-nodes-base.httpRequest |
| Critical QC Gate | n8n-nodes-base.stickyNote |
| AI Scripting Layer | n8n-nodes-base.stickyNote |
| Google Sheets - Log Published Content | n8n-nodes-base.googleSheets |

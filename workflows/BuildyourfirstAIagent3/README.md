# Workflow: Build your first AI agent 3

## Overview

This document provides an overview of the 'Build your first AI agent 3' workflow.
...
| Introduction Note | n8n-nodes-base.stickyNote |
| Sticky Note12 | n8n-nodes-base.stickyNote |
| Sticky Note13 | n8n-nodes-base.stickyNote |
| Sticky Note15 | n8n-nodes-base.stickyNote |
| Sticky Note16 | n8n-nodes-base.stickyNote |
| Get News | n8n-nodes-base.rssFeedReadTool |
| Get Weather | n8n-nodes-base.httpRequestTool |
...
```json
{
  "name": "Build your first AI agent 3",
  "nodes": [
    {
      "parameters": {

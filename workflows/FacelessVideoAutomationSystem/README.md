# Workflow: Faceless Video Automation System

## Overview

This document provides an overview of the 'Faceless Video Automation System' workflow.
...
| Generate Script with GPT-4o | n8n-nodes-base.openAi |
| Parse Script JSON | n8n-nodes-base.code |
| Save Scenes to Airtable | n8n-nodes-base.airtable |
| Generate Image - Leonardo AI | n8n-nodes-base.httpRequest |
| Wait for Image Generation | n8n-nodes-base.wait |
| Fetch Generated Image | n8n-nodes-base.httpRequest |
| Extract Image URL | n8n-nodes-base.code |
| Generate Voiceover - ElevenLabs | n8n-nodes-base.httpRequest |
| Upload Audio to Drive | n8n-nodes-base.googleDrive |
| Download Image | n8n-nodes-base.httpRequest |
| Upload Image to Drive | n8n-nodes-base.googleDrive |
| Merge Image + Audio Data | n8n-nodes-base.merge |
| Aggregate All Scenes | n8n-nodes-base.code |
| Build Shotstack Timeline | n8n-nodes-base.code |
| Render Video - Shotstack | n8n-nodes-base.httpRequest |
| Wait for Video Render | n8n-nodes-base.wait |
| Check Render Status | n8n-nodes-base.httpRequest |
| Update Airtable with Video | n8n-nodes-base.airtable |
| Check if Render Complete | n8n-nodes-base.if |

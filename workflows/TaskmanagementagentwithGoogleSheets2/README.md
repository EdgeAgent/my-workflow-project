# Workflow: Task management agent (with Google Sheets) 2

## Overview

This document provides an overview of the 'Task management agent (with Google Sheets) 2' workflow.
...
| Get tasks | n8n-nodes-base.googleSheetsTool |
| Create task | n8n-nodes-base.googleSheetsTool |
| Update task | n8n-nodes-base.googleSheetsTool |
| Delete task | n8n-nodes-base.googleSheetsTool |
| Task management agent | @n8n/n8n-nodes-langchain.agent |
...
```json
{
  "name": "Task management agent (with Google Sheets) 2",
  "nodes": [
    {
      "parameters": {
        "model": {

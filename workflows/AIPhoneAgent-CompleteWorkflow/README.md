# Workflow: AI Phone Agent - Complete Workflow

## Overview

This document provides an overview of the 'AI Phone Agent - Complete Workflow' workflow.
...
| Twilio - Greeting | n8n-nodes-base.twilio |
| Twilio - Record Name | n8n-nodes-base.twilio |
| HTTP Request - Get Transcription | n8n-nodes-base.httpRequest |
| Set - Customer Info | n8n-nodes-base.set |
| OpenAI - Process Name | @n8n/n8n-nodes-langchain.openAi |
| Set - AI Response | n8n-nodes-base.set |
| Twilio - Say Response | n8n-nodes-base.twilio |
| Twilio - Record Need | n8n-nodes-base.twilio |
| HTTP Request - Get Need Transcription | n8n-nodes-base.httpRequest |
| Set - Customer Need | n8n-nodes-base.set |
| OpenAI - Qualify Customer | @n8n/n8n-nodes-langchain.openAi |
| Twilio - Ask Qualifying Questions | n8n-nodes-base.twilio |
| Twilio - Record Response | n8n-nodes-base.twilio |
| HTTP Request - Get Response | n8n-nodes-base.httpRequest |
| Set - Qualification Response | n8n-nodes-base.set |
| IF - Wants Appointment | n8n-nodes-base.if |
| Google Calendar - Get Events | n8n-nodes-base.googleCalendar |
| Code - Calculate Available Slots | n8n-nodes-base.code |
| Merge - Combine Slots | n8n-nodes-base.merge |
| Code - Format Slots | n8n-nodes-base.code |
| OpenAI - Offer Slots | @n8n/n8n-nodes-langchain.openAi |
| Twilio - Offer Times | n8n-nodes-base.twilio |
| Twilio - Record Choice | n8n-nodes-base.twilio |
| HTTP Request - Get Choice | n8n-nodes-base.httpRequest |
| OpenAI - Parse Choice | @n8n/n8n-nodes-langchain.openAi |
| Code - Get Selected Slot | n8n-nodes-base.code |
| Google Calendar - Create Event | n8n-nodes-base.googleCalendar |
| Postgres - Save Customer | n8n-nodes-base.postgres |
| Twilio - Confirmation | n8n-nodes-base.twilio |
| Twilio - Send SMS | n8n-nodes-base.twilio |
| Slack - Notify Team | n8n-nodes-base.slack |
| Postgres - Log Call | n8n-nodes-base.postgres |
| Respond to Webhook | n8n-nodes-base.respondToWebhook |
| OpenAI - Continue Conversation | @n8n/n8n-nodes-langchain.openAi |
| Twilio - Continue Response | n8n-nodes-base.twilio |
| Twilio - Record Follow-up | n8n-nodes-base.twilio |
| HTTP Request - Get Follow-up | n8n-nodes-base.httpRequest |
| Set - Follow-up Response | n8n-nodes-base.set |
| IF - Now Wants Appointment | n8n-nodes-base.if |
| Postgres - Log No Booking | n8n-nodes-base.postgres |
| Twilio - Goodbye | n8n-nodes-base.twilio |
| Twilio - Hangup | n8n-nodes-base.twilio |

# Workflow: Scrape New Competitors

## Overview

This document provides an overview of the 'Scrape New Competitors' workflow.
...
| Parameters | n8n-nodes-base.googleSheets |
| Google Search | n8n-nodes-base.httpRequest |
| Aggregate | n8n-nodes-base.aggregate |
| 4.1 | @n8n/n8n-nodes-langchain.lmChatOpenAi |
| Search Array | @n8n/n8n-nodes-langchain.outputParserStructured |
| Search Agent | @n8n/n8n-nodes-langchain.agent |
| Split Out | n8n-nodes-base.splitOut |
| Filter | n8n-nodes-base.filter |
| Loop Over Items | n8n-nodes-base.splitInBatches |
| HTTP Request | n8n-nodes-base.httpRequest |
| Relevant Text | n8n-nodes-base.code |
| AI Agent | @n8n/n8n-nodes-langchain.agent |
| Structured Output Parser | @n8n/n8n-nodes-langchain.outputParserStructured |
| Split Out1 | n8n-nodes-base.splitOut |
| Existing Info | n8n-nodes-base.googleSheets |
| Switch | n8n-nodes-base.switch |
| Loop Products | n8n-nodes-base.splitInBatches |
| Set Product | n8n-nodes-base.set |
| Add Product | n8n-nodes-base.googleSheets |
| Aggregate1 | n8n-nodes-base.aggregate |
| New Count | n8n-nodes-base.googleSheets |
...
| Alert User | n8n-nodes-base.telegram |
| Delay Wait | @n8n/n8n-nodes-langchain.toolCode |
| aAI 4.1 | @n8n/n8n-nodes-langchain.lmChatOpenRouter |
